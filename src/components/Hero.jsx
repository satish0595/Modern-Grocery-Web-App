            ...
            <div className='max-w-6xl mx-auto py-16 flex flex-col md:flex-row items-center px-6 md:px-0 gap-7'>
                <div className='md:w-1/2 mb-8 md:mb-0'>
                    ...
                    <div className='flex flex-wrap gap-4'>
                        <button className='bg-white text-green-600 hover:bg-gray-100 rounded-full px-3 py-1'>Shop Now</button>
                        <button className='text-white border-white bg-green-700 hover:bg-green-600 rounded-full px-3 py-2'>Learn More</button>
                    </div>
                </div>
